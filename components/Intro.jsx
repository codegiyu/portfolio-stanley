    ...
    return (
        <div className="w-full flex flex-col gap-6 lg:gap-12">
            <div className="flex flex-col gap-10 font-montserrat text-[#FAFAFA]">
                ...
                <p className="font-poppins font-normal text-sm lg:text-lg leading-[150%] tracking-normal">I like to build beautiful, fun and interactive things with code. 
                I'm dedicated to the quest of developing solutions that leverage on best practice technologies to deliver over the top user experiences.
                </p>
            </div>
